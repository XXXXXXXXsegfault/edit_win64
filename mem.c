...
#define _MEM_C_
asm "@_memmove_start"
void *__memcpy(void *dst,void *src,unsigned long int size)
{
	asm "push %rcx"
	asm "push %rdx"
	asm "push %rbx"
...
void memcpy_sse(void *dst,void *src,unsigned long blocks); //1 block == 128 bytes
asm "@memcpy_sse"
asm "mov 8(%rsp),%rax"
asm "mov 16(%rsp),%rdx"
asm "mov 24(%rsp),%rcx"
...
void *memcpy(void *dst,void *src,unsigned long int size)
{
	...
	__memcpy((char *)dst+(blocks<<7),(char *)src+(blocks<<7),size);
}
